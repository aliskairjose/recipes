...
export default function MealCard({ meal }) {
  return (
    <div className="h-[24.5rem] w-[19rem] rounded overflow-hidden shadow-md border border-gray-300">
      ...
      <div className="px-2">
        ...
        <div className="flex justify-around uppercase text-xs my-2">
          <div>
            <span className="me-1 text-sky-600">180</span>
            <span>Calorias</span>
          </div>
          <div>
            <span className="me-1 text-sky-600">{meal.ingredients.length}</span>
